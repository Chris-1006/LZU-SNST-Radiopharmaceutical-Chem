...
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{0090.jpg}
\end{figure*}
...
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{0096.jpg}
\end{figure*}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{0106.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{0106[2].jpg}
    \bicaption{Collimator}{准直器} \label{fig104}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{0107.jpg}
...
\begin{figure}[h]
	\centering
    \includegraphics[width=0.45\textwidth]{0146.jpg}    
...
\begin{figure}[h]
	\centering
    \includegraphics[width=0.75\textwidth]{0163.jpg}    
...
\begin{figure*}[h]
	\centering
    \includegraphics[width=0.6\textwidth]{0168.jpg}    
\end{figure*}
...
\begin{figure}[h]
	\centering
    \includegraphics[height=.15\textheight]{0178.jpg}   
...
\begin{wrapfigure}{r}{0.35\textwidth}
    \centering
    \includegraphics[width=0.3\textwidth]{0201[3].jpg}
...
\begin{wrapfigure}{r}{0.4\textwidth}
    \centering
    \includegraphics[width=0.2\textwidth]{0203[3].jpg}
...
\begin{figure*}[h]
	\centering
    \includegraphics[width=0.45\textwidth]{0231.jpg}  
\end{figure*}
...
\begin{figure}[h]
    ...
    \bicaption{Isotopes of yttrium, \(\mathrm{^{86}Y}\) and \(\mathrm{^{90}Y}\) (in purple frame) are used in nuclear medicine}{铱的同位素，\(\mathrm{^{86}Y}\)和\(\mathrm{^{90}Y}\)（紫色框）用于核医学} \label{fig341}
\end{figure}
...
\begin{figure}[h]
    ...
    \bicaption{Bifunctional chelators for Lu3+ and Y3+}{用于Lu\(^3+\)和Y\(^3+\)的双功能配体} \label{fig346}
\end{figure}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering
    \includegraphics[width=0.25\textwidth]{0263.jpg}  
...
\begin{figure}[h]
	\centering
    \includegraphics[width=0.6\textwidth]{0274.jpg}  
...
\begin{figure}[h]
	\centering
    \includegraphics[width=0.6\textwidth]{0277.jpg}  
...
\begin{figure}[h]
    ...
    \bicaption{Lead bricks in form of chevrons (to ensure overlapping and prevent ray leakage) are used to make “lead castles” to enclose sources of gamma radiation.}{呈人字形的铅砖（确保重叠并防止射线泄漏）用于制造“铅城堡”来包围$\gamma$辐射源} \label{fig377}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[height=0.2\textheight]{0285.jpg} \hspace{0.1in}
    \includegraphics[height=0.2\textheight]{0285[2].jpg} \hspace{0.1in}
    \includegraphics[height=0.2\textheight]{0285[3].jpg}  \hspace{0.1in}
    \includegraphics[height=0.2\textheight]{0285[4].jpg}  \hspace{0.1in}
    \includegraphics[height=0.2\textheight]{0285[5].jpg} 
